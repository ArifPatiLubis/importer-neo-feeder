        ...
        <div class="card">
            <div class="card-body">
                <h3 style="font-family: 'Bebas Neue', sans-serif; color: #006633;
                        font-weight: bold; text-align: left; margin-bottom: 1rem">Referensi Jenis Evaluasi</h3>
...
<script>
    $(document).ready(function() {
        $('#refJenjangPendidikan').DataTable({
            ajax: {
                url: '/Administrator/Referensi/Jenis-Evaluasi'
            },
            columns: [
                { data: 'id_jenis_evaluasi' },
                { data: 'nama_jenis_evaluasi' }
            ]
        });
    });
</script>
