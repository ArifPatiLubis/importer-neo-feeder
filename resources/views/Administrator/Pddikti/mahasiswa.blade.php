...
@section('title', 'Mahasiswa PDDIKTI')
...
<div class="row" id="hasil" style="display: none">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h3 style="font-family: 'Bebas Neue', sans-serif; color: #006633;
                        font-weight: bold; text-align: left; margin-bottom: 1rem">Data Mahasiswa Terdaftar PDDIKTI</h3>
                        <hr style="border: 1px solid #C0C0C0">
...
<script>
    ...
    function buildUrl() {
        ...
        return '/Administrator/Data-Pddikti/Mahasiswa/Cari?id_prodi=' + idProdi + '&id_periode=' + idPeriode;
    }
            ...
            columns: [
                ...
                { data: 'status_sync',
                    render: function (data, type, row, meta) {
                            if(data == "sudah sync") {
                                return '<div class="sync"><i class="ace-icon fa fa-check text-success" style="font-size: 16px;"></i><p class="mb-0" style="font-size: 12px; font-weight:bold">Sudah Sync</p></div>'
                            } else {
                                return '<div class="notsync"><i class="ace-icon fa fa-times text-danger" style="font-size: 16px;"></i><p class="mb-0" style="font-size: 12px; font-weight:bold">Belum Sync</p></div>'
                            }
                        },
