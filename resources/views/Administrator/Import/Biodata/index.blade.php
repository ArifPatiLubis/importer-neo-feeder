        ...
        <div class="card">
            <div class="card-body">
                <h3 style="font-family: 'Bebas Neue', sans-serif; color: #006633;
                        font-weight: bold; text-align: left; margin-bottom: 1rem">Import Biodata Mahasiswa</h3>
                        <hr style="border: 1px solid #C0C0C0">
                <div class="card-description">
                    <p>Petunjuk :</p>
                    <ol class="list">
                        <li>Download file template excel <a
                                href="{{ url('files/import-mahasiswa.xlsx') }}">disini</a></li>
                        <li>Isikan data mahasiswa baru menggunakan file excel sesuai petunjuk</li>
                    </ol>
                </div>
                <form action="{{ url('/Administrator/Import/Biodata/Singkron') }}" method="post" enctype="multipart/form-data"
                    id="formImport">
                    @csrf
                    <div class="row">
...
<script>
    $(document).ready(function() {
        let table = $('#logImport').DataTable({
            ajax: {
                url: '/Administrator/Import/Biodata',
                dataSrc: ''
            },
            columns: [
