        ...
        <div class="card">
            <div class="card-body">
                <h3 style="font-family: 'Bebas Neue', sans-serif; color: #006633;
                        font-weight: bold; text-align: left; margin-bottom: 1rem">Import Histori Pendidikan Mahasiswa</h3>
                        <hr style="border: 1px solid #C0C0C0">
                <div class="card-description">
                    <p>Petunjuk :</p>
                    <ol class="list">
                        <li>Download file template excel <a
                                href="{{ url('files/import-riwayat-pendidikan-mahasiswa.xlsx') }}">disini</a></li>
                        <li>Isikan data mahasiswa baru menggunakan file excel sesuai petunjuk</li>
                    </ol>
                </div>
                <form action="{{ url('/Administrator/Import/Histori/Singkron') }}" method="post" enctype="multipart/form-data"
                    id="formImport">
                    @csrf
                    <div class="row">
                        <div class="form-group col-lg-5 @error('program_studi') has-danger @enderror">
                            ...
                            <select class="form-control @error('program_studi') form-control-danger @enderror"
                                ...
                                <option value="{{ $prodi['id_prodi'] }}" {{ old('prodi')==$prodi['id_prodi']
                                    ? 'selected' : '' }}>
...
<script>
    $(document).ready(function() {
        let table = $('#logImport').DataTable({
            ajax: {
                url: '/Administrator/Import/Histori',
                dataSrc: ''
            },
            columns: [
