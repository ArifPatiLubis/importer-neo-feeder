...
@section('title', 'Import Peserta Kelas Perkuliahan')
            ...
            <div class="card">
                <div class="card-body">
                    <h3 style="font-family: 'Bebas Neue', sans-serif; color: #006633;
                        font-weight: bold; text-align: left; margin-bottom: 1rem">Import Peserta Kelas/KRS Mahasiswa</h3>
                        <hr style="border: 1px solid #C0C0C0">
                    <div class="card-description">
                        <p>Petunjuk :</p>
                        <ol class="list">
                            <li>Download file template excel <a
                                    href="{{ url('files/import-peserta-kelas.xlsx') }}">disini</a></li>
                            <li>Isikan data aktivitas mahasiswa menggunakan file excel sesuai petunjuk</li>
                        </ol>
                    </div>
                    <form action="{{ url('/Administrator/Import/Peserta-Kelas/Singkron') }}" 
...
<script>
    $(document).ready(function() {
        let table = $('#logImport').DataTable({
            ajax: {
                url: '/Administrator/Import/Peserta-Kelas',
                dataSrc: ''
            },
            columns: [
